...
function boxBase:Update()
    ...
    if Vis5 then
        ...
        self.Components.Distance.Text = string.format("[%s][%s][%s]", math.floor((Camera.CFrame.Position - cf.Position).Magnitude), self.Extra.Health.Value.."/"..self.Extra.Health.MaxValue, self.Extra.BP.Value)
