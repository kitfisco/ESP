...
function boxBase:Update()
    ...
    if ESP.Names then
        ...
        if Vis5 then
            ...
            self.Components.Distance.Text = string.format("[%s][%s][%s]", math.floor((cam.CFrame.Position - cf.Position).Magnitude), self.Health.Value.."/"..self.Health.MaxValue, self.BattlePower.Value)
