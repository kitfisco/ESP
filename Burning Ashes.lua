...
do
    ...
    function boxBase:Update()
        ...
        if Vis5 then
            ...
            self.Components.Distance.Text = string.format("[%s][%s][%s]", math.floor((Camera.CFrame.Position - cf.Position).Magnitude), math.floor(self.Humanoid.Health).."/"..math.floor(self.Humanoid.MaxHealth), "Lv."..math.round((self.Humanoid.MaxHealth-100)/2.5))
...
function ESP:Add(obj, options)
    ...
    local box = setmetatable({
        ...
        Type = "Box",
        Object = obj,
        Humanoid = options.Humanoid or obj:FindFirstChild("Humanoid"),
